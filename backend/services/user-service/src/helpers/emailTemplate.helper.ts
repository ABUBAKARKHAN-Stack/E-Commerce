  ...
  <html>
    ...
    <body>
      <div class="container">
        ...
        <p>You can track your order using the ShopNex website by using your <strong>Order ID: ${orderId}</strong>. Click <a href="http://localhost:5173/track-order/${orderId}" style="color: #00bcd4; text-decoration: none;">here</a> to track your order.</p>
