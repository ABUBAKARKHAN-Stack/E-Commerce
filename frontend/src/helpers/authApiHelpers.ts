import { ApiErrorType, IAdmin, IUser, LoginPayload, RoleType } from "@/types/main.types";
import { forgotPasswordUser, getUser, loginUser, logoutUser, resetPasswordUser, updateUserPassword, updateUserProfile } from "@/API/userApi";
import { forgotPasswordAdmin, getAdmin, loginAdmin, logoutAdmin, resetPasswordAdmin, updateAdminPassword, updateAdminProfile } from "@/API/adminApi";
...
const forgotPasswordHelper = async (
    { isAdmin, data }: ForgotPasswordType
) => {
    try {
        const res = isAdmin
