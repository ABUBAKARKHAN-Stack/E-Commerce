import { Camera, Gamepad, Laptop, ShoppingCart, Smartphone, Tv, Watch } from 'lucide-react'
...
const staticCategoriesData: StaticCategory[] = [
    ...
    { icon: <Smartphone size={50} />, title: "Smartphones", category: "smartphones" },
    { icon: <Tv size={50} />, title: "Televisions", category: "televisions" },
    { icon: <Watch size={50} />, title: "Smartwatches", category: "smartwatches" },
