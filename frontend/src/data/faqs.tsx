...
const commonFaqs = [
        ...
        answer: (
            <>
                ...
                <Link
                    to="/track-order"
                    target="_blank"
                    className="underline font-medium text-white dark:hover:text-orange-200 hover:text-cyan-100"
                >
                    Track Order
                </Link>{" "}
    ...
    },
    {
        ...
        answer: (
            <>
                ...
                section in your dashboard. There, you'll find a complete list of your orders along with their Order IDs and basic details.
            </>
        ),
    },
    {
    ...
    },
    {
        ...
        answer: "Yes, shipping is free for orders above $1000. For orders under $1000, standard shipping costs $6.99 and express shipping costs $9.99.",
    },
];
...
const detailedFaqs = [
    ...commonFaqs,
    {
        ...
        answer: "We accept two payment methods: Cash on Delivery and secure online card payments via Stripe.",
    },
    {
        id: 7,
    ...
    },
    {
        ...
        answer: (
            <>
                ...
                page, then select the specific order you wish to cancel and click <strong>“View Full Details”</strong>.
                If the order is still eligible based on its status, you'll see the <strong>“Cancel Order”</strong> button.
                <br />
                <br />
                <span className="font-medium">Note:</span> Orders can only be canceled within 1 hour of placement or confirmation.
            </>
        ),
    },
    {
        ...
        answer: (
            <>
                ...
                page, then select the specific order and click <strong>“View Full Details”</strong>. If your order is eligible, you'll find the <strong>“Download Invoice”</strong> button there.
                <br />
                <br />
                <span className="font-medium">Note:</span> Invoice download is disabled for orders that are still in <strong>Pending</strong> status.
            </>
        ),
    },
    {
