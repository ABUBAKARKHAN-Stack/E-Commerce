...
import { userInterceptor } from "./axiosInterceptor";
...
//* Get USER
const getUser = async () => {
  return await userInterceptor.get("/get-profile");
};
...
const updateUserProfile = async (data: any) => {
  return await userApi.patch("/update/profile", data, {
    withCredentials: true,
  });
};
...
const addToWishList = async (productId: string) => {
  return await userProductApi.post(
    "/add-to-wishlist",
    { productId },
    {
      withCredentials: true,
...
const updateCart = async (productId: string, quantity: number) => {
  return await userProductApi.put(
