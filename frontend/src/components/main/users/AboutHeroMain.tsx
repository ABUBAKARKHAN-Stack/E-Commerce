...
const AboutHeroMain = () => {
    ...
    return (
        <main className="w-full min-w-screen overflow-hidden h-full min-h-[calc(80vh-80px)] py-16 md:py-24 bg-gradient-to-b from-[#F3F4F6] via-[#E5E7EB] to-[#F3F4F6] flex flex-col justify-center items-center dark:bg-gradient-to-b dark:from-[#1B1B1F] border-b-2 dark:via-[#27272A] dark:to-[#1B1B1F] backdrop-blur-xl">
            <WaveDivider
            ...
            <Layout>
                ...
                <section className='mt-10 w-full flex flex-col justify-center items-center space-y-10'>
                    <AboutHero />
                </section>
            </Layout>
            <WaveDivider
