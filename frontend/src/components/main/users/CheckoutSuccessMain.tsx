...
const CheckoutSuccessMain = () => {
  ...
  return (
    <main
      ref={containerRef}
      className="h-full w-full min-w-screen overflow-x-hidden bg-gradient-to-b from-[#F3F4F6] via-[#E5E7EB] to-[#F3F4F6] py-10 dark:bg-gradient-to-b dark:from-[#1B1B1F] dark:via-[#27272A] dark:to-[#1B1B1F]"
    >
      <Layout>
        <section className="mx-auto mt-10 w-full max-w-2xl space-y-8">
