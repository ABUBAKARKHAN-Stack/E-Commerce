...
const EmptyWishlist = () => {
  return (
    <main className="relative h-full min-h-[75vh] w-full min-w-screen overflow-x-hidden border-b-2 bg-gradient-to-b from-[#F3F4F6] via-[#E5E7EB] to-[#F3F4F6] py-10 backdrop-blur-xl dark:bg-gradient-to-b dark:from-[#1B1B1F] dark:via-[#27272A] dark:to-[#1B1B1F]">
        ...
        <BlurFade inView delay={0.1} duration={0.25} direction="down">
          <div className="relative">
            ...
            <div className="z-10 flex h-20 w-20 items-center justify-center rounded-full border border-cyan-200/40 bg-cyan-500 dark:border-orange-400/50 dark:bg-orange-500">
              <Heart className="size-10 text-cyan-100 drop-shadow-md dark:text-orange-200" />
            </div>
          </div>
        </BlurFade>
        ...
        <BlurFade inView delay={0.35} direction="down">
          <div className="mx-auto space-y-4 px-4 text-center">
            ...
            <p className="mx-auto w-full text-lg leading-relaxed font-medium text-gray-900 sm:w-3/4 md:text-xl dark:text-gray-300">
              ...
              shopping and adding items in wishlist to see your items here!
            </p>
            <p className="text-muted-foreground text-sm font-light">
              Discover amazing products and add them to your wishlist to get
              started.
            </p>
          </div>
        </BlurFade>
