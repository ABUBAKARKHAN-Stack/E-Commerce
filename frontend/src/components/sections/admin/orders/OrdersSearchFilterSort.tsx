...
const OrdersSearchFilterSort: FC<Props> = ({ limit, page, setPage }) => {
    ...
    const debouncedSearchOrderByCustomerName = useDebounce(filters.searchOrderByCustomerName || '', 300);
    ...
    const queryParams = useMemo(() => {
        ...
        if (debouncedSearchOrderByCustomerName) params.customerName = debouncedSearchOrderByCustomerName;
        return params;
    }, [
        filters.status,
        filters.paymentMethod,
