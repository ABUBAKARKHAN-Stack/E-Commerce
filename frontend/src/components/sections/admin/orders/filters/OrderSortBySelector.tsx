...
const OrderSortBySelector: FC<Props> = ({ filters, setFilters }) => {
  const sortByOptions = [
    {
      label: (
  ...
  return (
    <div className="flex flex-col gap-y-3">
      <div>
        <h3 className="flex items-center gap-x-1.5 text-lg font-semibold text-gray-900 dark:text-gray-300">
          <SortAsc />
          Sort Orders:
        </h3>
        <Separator />
      ...
      <Select
        ...
        placeholder="Sort By"
        className="bg-[#f8f7f7]/80 dark:bg-[#18181b]/80"
