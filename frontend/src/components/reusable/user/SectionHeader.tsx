...
const SectionHeader: FC<SectionHeaderProps> = ({ mainHeading, subText, animateOnce = false }) => {
    return (
        <div className='w-full flex flex-col gap-y-4 justify-center items-center'>
            <BlurFade direction="down" once={animateOnce} delay={0.25} inView>
                <h1 className='text-gray-950 dark:text-white text-center text-2xl xsm:text-4xl md:text-5xl xl:text-6xl font-bold'>
                    {mainHeading}
                </h1>
            </BlurFade>
            <BlurFade once={animateOnce} direction="down" delay={0.25 * 2} inView>
