...
const addReviewSchema = z.object({
  ...
  review: z
    ...
    .min(20, {
      message:
        "Your review is too short. Please write at least 20 characters to help others.",
    })
    .max(300, {
      message:
        "Your review is too long. Please keep it under 300 characters to stay concise.",
    }),
});

export { addReviewSchema };
